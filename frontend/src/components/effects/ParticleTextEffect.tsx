...
const DEFAULT_WORDS = ["SIMPLIFY", "ORGANIZE", "SCALE", "SUCCEED", "CLIV\u221e", "TENSPICK"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Electric blue brand color palette tinting for particles
    const newColor = {
      r: Math.floor(0 + Math.random() * 30),
      g: Math.floor(150 + Math.random() * 105),
      b: Math.floor(220 + Math.random() * 35),
    }
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center p-4">
      <canvas
        ref={canvasRef}
        className="border border-blue-900/60 rounded-2xl shadow-2xl bg-[#0a1628] max-w-full"
