...
export const Login: React.FC = () => {
  ...
  const { login, signInWithGithub, signInWithGoogle, user, userProfile } = useAuth();
    ...
    <div className="space-y-6 bg-white/95 backdrop-blur-2xl p-8 rounded-3xl border border-sky-200 shadow-2xl shadow-sky-500/15 text-slate-900 font-['Sora']">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="py-2.5 px-4 bg-white hover:bg-sky-50 text-slate-800 font-bold text-xs border border-sky-200 hover:border-sky-300 rounded-xl transition-all shadow-xs flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
        >
